...
module.exports = {
	...
	async execute(interaction) {
		...
		if (mon.exists) {
			...
			// Get the abilities for the Pokemon in question
			...
			// This is really fucking stupid but mon.forme always exists even if it doesn't have a value so I have to trim it and check if its empty instead to know when to add the forme to the reply string
